            ...
            {[
              {
                ...
                description: "Quick 5-minute form covering medical history, lifestyle assessment, and family health background. Upload existing DNA test results or order our RM49 kit.",
              ...
              >
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <DashboardCard title="" delay={index * 0.2 + 0.4}>
