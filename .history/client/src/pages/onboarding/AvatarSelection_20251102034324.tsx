                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-8">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="text-lg font-bold text-white">Level 1</h3>
                          <p className="text-gray-400 text-sm">Profile Builder</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="w-16 h-16 bg-zinc-800 rounded-full flex items-center justify-center border-4 border-blue-600">
                    ...
                    <div className="mb-8">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-white font-semibold">Question {currentQuestion + 1} of {getTotalQuestions()}</span>
                      ...
                      {currentQuestion === 3 && (
                        ...
                        >
                          <div className="flex items-start gap-4 mb-6">
                            ...
                            <div className="flex-1">
                              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
                                What type of insurance interests you?
                              </h2>
                              <p className="text-green-400 text-sm flex items-center gap-1">
                                <span>●</span> Earn 10 points
                              </p>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {['Health', 'Life', 'Car', 'Travel'].map((type) => (
                              <button
                                ...
                                className={`px-6 py-4 rounded-xl transition-all duration-200 hover:scale-105 text-left flex items-center justify-between ${
                                  formData.insuranceTypes.includes(type)
                                    ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white'
                                    : 'bg-zinc-800 text-white hover:bg-zinc-700'
                                }`}
                              >
                                <span className="font-semibold">{type} Insurance</span>
                                {formData.insuranceTypes.includes(type) && <span className="text-xl">✓</span>}
                              </button>
                            ))}
                          </div>
                          <button
                            onClick={handleNext}
                            disabled={formData.insuranceTypes.length === 0}
                            className="w-full mt-6 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            Next Question →
                          </button>
