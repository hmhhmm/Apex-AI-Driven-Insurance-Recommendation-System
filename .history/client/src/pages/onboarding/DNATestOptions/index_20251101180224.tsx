...
export default function DNATestSelection() {
  ...
  const options = [
    ...
    {
      id: 'upload-existing' as const,
      icon: '📤',
      title: 'Upload Existing Results',
      price: 'FREE',
      description: 'Already have 23andMe, AncestryDNA, or similar?',
      features: [
        'Accepts 23andMe raw data',
        'Accepts AncestryDNA data',
        'Instant analysis',
        'No waiting period'
      ],
      popular: false
    ...
    {
      id: 'schedule-lab' as const,
      icon: '🏥',
      title: 'Visit Partner Lab',
      price: '$79',
      description: 'Blood draw at certified partner lab.',
      features: [
        'Most comprehensive analysis',
        'Professional sample collection',
        'Over 500+ partner locations',
