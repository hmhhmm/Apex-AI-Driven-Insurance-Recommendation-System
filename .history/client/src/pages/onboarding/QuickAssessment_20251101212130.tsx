...
const questions: Question[] = [
  { id: 'fullName', question: "What's your name?", type: 'text', placeholder: 'John Doe', emoji: '👤', category: 'Personal' },
  { id: 'age', question: 'How old are you?', type: 'slider', emoji: '🎂', category: 'Personal', min: 18, max: 100 },
  { id: 'location', question: 'Where do you live?', type: 'text', placeholder: 'Kuala Lumpur', emoji: '📍', category: 'Personal' },
  { id: 'occupation', question: "What's your occupation?", type: 'text', placeholder: 'Software Engineer', emoji: '💼', category: 'Personal' },
  { 
    id: 'insuranceNeeds', 
