...
export default function QuickAssessment() {
  ...
  return (
    <div className="h-screen bg-black flex flex-col items-center justify-center px-4 py-6 overflow-hidden">
      <div className="w-full max-w-2xl flex flex-col items-center">
        {/* Avatar in Upper Middle */}
        <motion.div
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <div className="w-48 bg-zinc-900 rounded-full h-1.5">
              <motion.div
        ...
        <div className="w-full">
          <AnimatePresence mode="wait" custom={direction}>
            <motion.div
              ...
              className="glass-effect rounded-2xl p-6 border border-zinc-800/50"
            >
              {/* Question */}
              ...
              <div className="space-y-2.5">
                {currentQuestion.type === 'text' && (
                  <input
                    ...
                    className="w-full px-4 py-3 bg-zinc-900 border border-zinc-800 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-500"
                    autoFocus
                  />
                )}
              ...
              {error && (
                <motion.div
                  ...
                  className="mt-3 p-2.5 bg-red-950/30 border border-red-800/30 rounded-lg text-red-400 text-sm"
                >
                  {error}
                </motion.div>
              )}
              ...
              <div className="flex gap-3 mt-5">
                {currentStep > 0 && (
                  <button
                    onClick={handleBack}
                    className="px-5 py-2.5 bg-zinc-900 text-gray-300 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-all font-medium"
                  >
                    ← Previous
                  </button>
                )}
                ...
                <button
                  onClick={handleNext}
                  className="flex-1 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:shadow-xl hover:shadow-blue-500/50 transition-all"
                >
